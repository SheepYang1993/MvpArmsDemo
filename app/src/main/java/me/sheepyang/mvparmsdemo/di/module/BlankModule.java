...
import me.sheepyang.mvparmsdemo.mvp.model.BlankModel;
...
public class BlankModule {
    ...
    /**
     * 构建BlankModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    BlankContract.View provideBlankView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    BlankContract.Model provideBlankModel(BlankModel model) {
        return model;
    }
}